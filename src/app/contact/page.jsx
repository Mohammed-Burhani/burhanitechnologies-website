...
export const metadata = {
  ...
  description: "Contact Burhani Technologies for custom software development, ERP implementation, and enterprise automation solutions. Located in Chennai, serving clients globally.",
  keywords: [
